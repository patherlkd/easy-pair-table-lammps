...
from potentials_for_lammps import pair_debug
...
pair_filename = "./Example_pair_debug.txt"
pair_keyword = "DEBUG"
clpt.make_table_for_lammps(pair_filename,pair_keyword,pair_debug, rmin, rmax, N,rctab)


# put the table through lammps and check it
lmps_input_filename = "./in.Example_lmps_pair_debug"
lmps_pair_filename = "./Example_lmps_pair_debug.txt"
...
clpt.comparison("Example_pair_debug",lmps_pair_filename,pair_filename,rmin,rc,rdelta,rmin,rc,-2,0,plot=True,markers=False) 
